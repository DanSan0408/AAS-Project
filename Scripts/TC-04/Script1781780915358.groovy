...
WebUI.setText(findTestObject('Page_Reset Password - UTM AAS/input_New Password'), 'DUMMY_PASSWORD')

WebUI.setText(findTestObject('Page_Reset Password - UTM AAS/input_Confirm New Password'), 'DUMMY_PASSWORD')
